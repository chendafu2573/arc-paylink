...
1. Open the live app: <https://13-212-95-171.sslip.io>
2. Open the live proof order: <https://13-212-95-171.sslip.io/?escrow=0x51a8242e1a04a1557b18a85d3e2da62d9b2eff92e1657b389ab331392b5c5c6f>
3. Confirm the escrow lifecycle on ArcScan:
   - Fund: <https://testnet.arcscan.app/tx/0x8eaa28e4ac6431ff73d21b1c92338b3a1dbe3533cd5d4876c658dcd917779c74>
   - Release: <https://testnet.arcscan.app/tx/0x05f37466ad220a1639cc82f427c9b4b5cc43041dc6751ea6fc1976be8b8c97c7>
4. Verify the machine-readable proof bundle:
   - Gateway proof: <http://13.212.95.171/gateway-proof.json>
   - Agent receipt: <http://13.212.95.171/agent-receipt.json>
5. Recompute the public receipt locally:
...
The verifier only uses public JSON, the onchain receipt anchor, and the ERC-8004 owner signature recovery path. It does not require a wallet file or private key.
